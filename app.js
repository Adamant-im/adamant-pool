...
setTimeout(async () => {
	...
	// payment = await api.sendMessage(config.passPhrase, address, '{"type":"eth_transaction","amount":"0.002","hash":"0xfa46db3c99878f1f9863fcbdb0bc27d220d7065c6528543cbb83ced84487deb","comments":"I like to send it, send it"}');
	// if (payment.success) {
