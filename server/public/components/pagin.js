Vue.component('pagin', {
	...
	computed:{
		...
		stopRow:function(){
			...
			var visible_count=this.rows.visible_count;
			if(this.startRow<0) this.startRow=0;
			var startRow=this.startRow;
			var stopRow=this.startRow+this.visible_count;
			if(count_rows < stopRow || startRow>count_rows) startRow=count_rows-this.visible_count;
